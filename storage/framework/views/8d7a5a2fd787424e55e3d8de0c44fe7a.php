                                    ...
                                    <section>
                                        ...
                                        <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                                            <div class="relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
                                                <h1 class="mt-1 text-lg font-semibold text-white sm:text-slate-900 md:text-2xl dark:sm:text-white"> <?php echo e($item->package_name); ?>

                                                </h1>
                                                <p class="text-sm leading-4 font-medium text-white sm:text-slate-500 dark:sm:text-slate-400"><?php echo e($item->community->community_name); ?></p>
                                            </div>
...
<?php endif; ?><?php /**PATH D:\INFORMATIKA ITS\SEM 5\PWEB\ETS\EF234301_WEBPRO-E-_MID_5025211023_Wan-Sabrina-Mayzura_5025211036_Mashita-Dewi-main\resources\views/frontpage/landingpage.blade.php ENDPATH**/ ?>